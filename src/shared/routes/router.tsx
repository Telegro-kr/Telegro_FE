...
const GuestOrders = lazy(() => import('@pages/public/guest-orders'));
...
const AdminOrderDetail = lazy(() => import('@pages/admin/orders/order-detail'));
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: 'guest/orders', element: <GuestOrders /> },
